...
Use [GitHub Issues](https://github.com/Bridge-UI/docs/issues) in this repository to report documentation problems. Before opening a new issue, search existing ones to avoid duplicates.
...
For **component library bugs** (runtime behavior, API issues, etc.), open an issue in [Bridge-UI/core](https://github.com/Bridge-UI/core/issues) instead.
...
- Translation issues (`en-us` / `pt-br`)
- Accessibility or UX feedback on the docs site
...
Bridge UI is open-source software licensed under the [MIT license](https://github.com/Bridge-UI/core/blob/main/LICENSE.md).
